...
const ActualizarVenta = () => {
    ...
    return ( <
        ...
        id = "nombree"
        placeholder = "nombre del encargado" / > < /p> <
        p > < input type = "text"
        name = "correoencargado"
        id = "correoe"
        placeholder = "correo@innovasoft.com" / > < /p> <
        p > < input type = "text"
        name = "idencargado"
        id = "idencargado"
        placeholder = "Id Encargado" / > < /p> <
        /li>
        ...
        name = "nombrecliente"
        id = "nombrec"
        placeholder = "nombre del cliente" / > < /p> <
        p > < input type = "text"
        ...
        button class = "button1"
        type = "submit"
        name = "guardarventa" > Guardar < /button> <
        /div>
